...
| **RF-07** | RF | **Registro de la identidad del receptor real:**<br/>El sistema debe permitir capturar la información de la persona que recibe físicamente el paquete en destino, registrando si la entrega fue recibida por la consultora titular o por una persona autorizada. | Socio Logístico / Transportista | Entrega | **Alta** | `[Derivado de una necesidad expresada]`<br/>*(La fuente confirma que reciben personas autorizadas y que no se comunica; los campos específicos y bloqueos son derivados).* | **PR-05:** Falta de visibilidad sobre receptor real y reclamos prematuros | Línea 25<br/>(min 24:45–25:01) |
