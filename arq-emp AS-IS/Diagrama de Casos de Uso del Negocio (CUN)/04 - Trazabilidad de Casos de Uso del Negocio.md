...
| **RF-07** | Registro de la identidad del receptor real | `CUN-03` | Captura de la condición de quien recibe (titular o persona autorizada). |
...
| **RF-12** | Visualización de datos del receptor en consulta | `CUN-05` | Necesidad derivada de visibilizar oportunamente el receptor real (persona autorizada) para mitigar reclamos infundados de no-entrega (**PR-05**). |
...
| **"Obligatoriedad de DNI y bloqueo de sistema"** | `CUN-03` | ✅ **Ausente** | Se captura la condición de quien recibe (titular o persona autorizada) sin campos rígidos no sustentados. |
